    ...
    <section className='areas_section'>
      ...
      <div className='areas'>
        <div className='areas_card'>
          ...
          <a href='/family'  className='areas_card-title'>Family Law</a>
        ...
        <div className='areas_card'>
          <div className='areas_card-img2'></div>
            <a href='/divorce' className='areas_card-title'>Divorce LAW</a>
        ...
        <div className='areas_card'>
          <div className='areas_card-img3'></div>
            <a href='/wrongful' className='areas_card-title'>Wrongful Death</a>
        ...
        <div className='areas_card'>
          <div className='areas_card-img4'></div>
            <a href='/accident' className='areas_card-title'>Car Accidents</a>
        ...
        <div className='areas_card'>
          <div className='areas_card-img5'></div>
            <a href='/injury' className='areas_card-title'>Personal Injury</a> 
        ...
        <div className='areas_card'>
          <div className='areas_card-img6'></div>
            <a href='/criminal' className='areas_card-title'>Criminal Defense</a>
