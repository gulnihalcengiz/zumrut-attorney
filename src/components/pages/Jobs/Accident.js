...
const Accident = () => {
  return (
    <>
      <section className='accident_law' id='areas_item'>
        <div className='accident' id='accident'>
          <h2 className='law_title'>CAR ACCIDENTS</h2>
        <span>Zümrüt Attorney |</span> Our team of wrongful death attorneys help family members rebuild after the death of a loved one. We have a team of wrongful death lawyers with experience in and out of the courtrooms in the Central Rockies to seek justice on your behalf.
...
Kalamaya | Goscha handles the following wrongful death cases:
